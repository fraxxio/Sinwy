		...
		<main className="page-wrap pb-8 pt-14">
			<section className="island-shell rise-in relative overflow-hidden rounded-[2rem] px-6 py-10 sm:px-10 sm:py-14">
				...
				<div className="flex flex-wrap gap-3">
					<Link
						to="/about"
						className="glass-button rounded-full border border-[rgba(50,143,151,0.3)] bg-[rgba(79,184,178,0.14)] px-5 py-2.5 text-sm font-semibold text-(--lagoon-deep) no-underline transition hover:bg-[rgba(79,184,178,0.24)]"
					>
						About This Starter
					</Link>
					<a
						...
						className="glass-button rounded-full border border-[rgba(23,58,64,0.2)] bg-white/50 px-5 py-2.5 text-sm font-semibold text-(--sea-ink) no-underline transition hover:border-[rgba(23,58,64,0.35)]"
					>
						Router Guide
					</a>
				</div>
